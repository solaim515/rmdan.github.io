...
output.innerHTML ='<h1 class="z">' + sound + '</h1>' + '<br/>' + '<h3>' + Text + '</h3>' + '<img style="width: 300px; height: auto;" src=" ' + img + ' ">' + '<br/>' + '<br/>' + '<p class="p">' + Text3 + '</p>' + '<p>' + name + '</p>' + '<h3>' +  name4 + '</h3>' + '<h5>' + f1 + '</h5>' + '<h3>' + Text2 + '</h3>' + '<h6>' + name2 + '</h6>' + '<h5 class="aa">' + name3 + '<b class="bc">' + f13 + '</b>' + '</h5>' + '<h5 class="aa" >' + f6 + '</h5>' + '<h5 class="aa">' + f2 + '<b class="bc">' + f13 + '</b>' + '</h5>' + '<h5 class="aa">' + f7 + '</h5>' + '<h5 class="aa">' + f3 + '<b class="bc">' + f13 + '</b>' + '</h5>' + '<h5 class="aa">' + f8 + '</h5>' + '<h5 class="aa">' + f5 + '<b class="bc">' + f13 + '</b>' + '</h5>' + '<h5 class="aa">' + f10 + '</h5>' + '<h5 class="aa">' + f12 + '</h5>' + '<h5 class="aa">' + f4 + '<b class="bc">' + f13 + '</b>' + '</h5>' + '<h5 class="aa">' + f11 + '</h5>' + '<h5 class="aa">' + f9 + '</h5>' + '<p class="p">' + f14 + '</p>' + '</div>';
